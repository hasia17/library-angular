(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@ngneat/cashew', ['exports', 'rxjs', 'rxjs/operators', '@angular/common/http', '@angular/core'], factory) :
    (factory((global.ngneat = global.ngneat || {}, global.ngneat.cashew = {}),global.rxjs,global.rxjs.operators,global.ng.common.http,global.ng.core));
    ...
    ***************************************************************************** */
    ...
    var DefaultTTLManager = /** @class */ (function () {
        ...
        /** @nocollapse */
        DefaultTTLManager.ctorParameters = function () {
            return [
    ...
    var HttpCacheManager = /** @class */ (function () {
        ...
        /** @nocollapse */
        HttpCacheManager.ctorParameters = function () {
            return [
                { type: RequestsQueue },
    ...
    function cloneWithoutParams(request, customKey, parameterCodec) {
        ...
        var clone = request.clone({
            params: new http.HttpParams(__assign({ fromObject: filteredParams }, (parameterCodec && { encoder: parameterCodec })))
        });
    ...
    var HttpCacheInterceptor = /** @class */ (function () {
            ...
            function (request, next) {
                ...
                if (this.httpCacheManager._isCacheable(canActivate, cache)) {
                    ...
                    if (this.httpCacheManager.validate(key)) {
                        return rxjs.of(this.httpCacheManager.get(key));
                    }
                    /** @type {?} */
                    var shared = next.handle(clone).pipe(operators.tap(( /**
                     * @param {?} event
                     * @return {?}
                     */function (event) {
        ...
        /** @nocollapse */
        HttpCacheInterceptor.ctorParameters = function () {
            return [
    ...
    var HttpCacheLocalStorage = /** @class */ (function () {
        ...
        /** @nocollapse */
        HttpCacheLocalStorage.ctorParameters = function () {
            return [
                { type: undefined, decorators: [{ type: core.Inject, args: [HTTP_CACHE_CONFIG,] }] }
            ];
        };
    ...
    var LocalStorageTTLManager = /** @class */ (function () {
        ...
        /** @nocollapse */
        LocalStorageTTLManager.ctorParameters = function () {
            return [
                { type: undefined, decorators: [{ type: core.Inject, args: [HTTP_CACHE_CONFIG,] }] }
            ];
        };
